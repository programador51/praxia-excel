...
var file = (0, _convertExcelToJson["default"])({
  sourceFile: "".concat(__dirname, "/../../src/Lista Conceptos/Plantillas carga de datos.xlsx"),
  columnToKey: {
    A: "id",
    B: "idTypeInformativeIncomes",
    C: "description"
  }
});
var conceptList = file["Conceptos Ingresos"].reduce(function (list, item, i) {
  if (i === 0) return list;
...
jsonexport(conceptList, function (err, csv) {
  ...
  var writer = fs.createWriteStream("Conceptos.csv");
  writer.write(csv);
