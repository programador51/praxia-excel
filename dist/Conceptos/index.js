...
var file = (0, _convertExcelToJson["default"])({
  sourceFile: "".concat(__dirname, "/../../src/Conceptos/Plantillas carga de datos.xlsx"),
  columnToKey: {
    Z: "id",
    AA: "description"
  }
});
var conceptsParsed = file["Plantillas"].reduce(function (list, item, i) {
  if (i === 0) return list;
...
jsonexport(conceptsParsed, function (err, csv) {
  ...
  var writer = fs.createWriteStream("TiposDeConcepto.csv");
  writer.write(csv);
